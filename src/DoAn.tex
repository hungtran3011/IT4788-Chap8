...
\addbibresource{../bib/Danh_sach_tai_lieu_tham_khao.bib} % chèn file chứa danh mục tài liệu tham khảo vào 
...
\chapter{TỔNG QUAN QUY TRÌNH PHÁT TRIỂN PHẦN MỀM}
\label{chapter:Introduction}
\subfile{Chuong/1_Tong_quan.tex} % Phần mở đầu
